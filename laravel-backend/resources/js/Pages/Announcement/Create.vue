...
// Define the form using Inertia's useForm helper
const form = useForm({
    department: '',
    publisher: '',
    publication_date: '',
    content_type: 'text', // Default is text content
    image: null,
    headline: '',
    body: '',
});

// Function to handle file selection for image uploads
const handleImageUpload = (event) => {
    form.image = event.target.files[0];
};

// Submit the form via Inertia post
const submit = () => {
